"""
    Usage:
        See the `main` function for more information. 
        
        python 1_tile_WSI.py -s 512 -e 0 -j 32 -B 50 -M 20 -o <full_patch_to_output_folder> "full_path_to_input_slides/*/*.svs"
        e.g., 
            python 1_tile_WSI.py -s 512 -e 0 -j 32 -B 50 -M 1 -o "patch" "minisample/train_images/0a0f8e20b1222b69416301444b117678.tiff"

        Run 1_run.py to process all the images in a given directory.

	Objective:
        Tile svs, jpg or dcm images with the possibility of rejecting some tiles; masks allowed. 
